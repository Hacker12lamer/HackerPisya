...
bot = telebot.TeleBot('1034277215:AAEpeTuFAN7OzAQKhnu7cNp1DfgJUbVNb1g')

admin = 1021472477

@bot.message_handler(commands=['start'])
def start_message(message):
	bot.send_message(message.chat.id, "Ну привет, братец!", parse_mode='HTML', reply_markup=keyboards.keyboardMain)
...
#-----------------------Команды-----------------------
	if message.text.lower() == 'оплатил':
		...
		if message.chat.id == admin:
			...
			msg = bot.send_message(message.chat.id, 'Сейчас установлена карта: '+ '1DKBnh15CTt9CFV3BrVcWejpQFd29RNX13'+'\n\nВведите новые данные\nP.S: Если вы случайно нажали на кнопку, укажите уже установленные данные')
